...
// 		var dateString = pattern.replace(/(MM|M|dd|d|HH|H|hh|h|mm|m|ss|s|SSS|a)/g, function(match) {
// 			var matchString = "";
// 			switch(match) {
// 				case "MM":
// 				case "M":
...
// 		} else {
// 			elapsedText = this.SimpleDateTimeFormat(date, "M.d H:m");
// 		}
